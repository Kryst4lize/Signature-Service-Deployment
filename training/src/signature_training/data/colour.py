...
inference/api/app/images.py carries the same function, and
inference/tests/test_tensors.py pins the two against each other — the same
arrangement already used for the Caffe preprocessing.
"""
